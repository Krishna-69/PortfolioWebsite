		...
		<section className="w-full bg-about padding-y rounded-t-[20px] z-20 relative mt-[-15px]">
			<div className="pl-[50px] sm:px-[20px] xm:px-[20px]">
				<h2 className="sub-heading font-medium font-NeueMontreal text-secondry">
					...
					<br className="sm:hidden xm:hidden" /> specializing in creating dynamic,  
					<br className="sm:hidden xm:hidden" /> and high-performance web applications
					<br className="sm:hidden xm:hidden" /> that drive business growth and user engagement
				</h2>
			</div>
					...
					<div className="w-[50%] sm:w-full xm:w-full">
						<div className="w-full flex gap-[30px] h-full items-end sm:items-start sm:flex-col xm:items-start xm:flex-col">
							<div className="w-[40%] sm:w-[60%] xm:w-[60%]">
								...
								I build reliable and scalable software solutions to help you streamline processes, enhance user experiences, or drive business growth. Whether it’s backend or frontend, designed for startups or enterprises.
								</p>
								<p className="sub-paragraph font-medium font-NeueMontreal text-secondry pt-[30px] tracking-wide">
									I believe the mix of strategy and design (with a bit of
